...
func (m *MockTaskRepository) Create(arg0 *domain.Task) error {
	m.ctrl.T.Helper()
...
func (m *MockTaskRepository) FindByID(arg0 uint) (*domain.Task, error) {
	m.ctrl.T.Helper()
...
func (m *MockTaskRepository) Update(arg0 *domain.Task) error {
	m.ctrl.T.Helper()
